...
public abstract class Utils {
	...
	public static boolean canSave(File aFile, Component aParent) {
		if (aFile.exists()) {
			return JOptionPane.showConfirmDialog(aParent, SM_FILEEXISTS, DT_FILEEXISTS,
...
//				OpenBrowser opener = null; // serviceRegistrar.getService(OpenBrowser.class);
//				if (opener != null) opener.openURL(e.getURL().toString());
//			}
//		}
//	}
}